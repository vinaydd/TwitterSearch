...
import com.example.TwitterResponse.TwitterResponse;
import com.example.TwitterResponse.TwitterStatusesModel;
import com.example.TwitterResponse.TwitterUserModel;
...
public class MainActivity extends AppCompatActivity {
    final static String SearchTerm = "NASA";
    ...
    private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
       ...
       // final static String TwitterSearchURL = "https://api.twitter.com/1.1/search/tweets.json?q=";
        final static String TwitterSearchURL = "https://api.twitter.com/1.1/search/tweets.json?result_type=popular&q=";
        ...
        private Searches jsonToSearches(String result) {
            ...
            if (result != null && result.length() > 0) {
                try {
                    ...
                    TwitterResponse data = gson.fromJson(result, TwitterResponse.class);
                    TwitterStatusesModel []  twitterStatusesModel  = data.getStatuses();
                    List<TwitterUserModel> list =  new ArrayList<>();
                    for(TwitterStatusesModel p : twitterStatusesModel ){
                        TwitterUserModel twitterUserModel  = p.getUser();
                        list.add(twitterUserModel);
                    }
                    TwitterUserModel twitterUserModel  = twitterStatusesModel[0].getUser();
